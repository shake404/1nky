...
const LANES: readonly Lane[] = [
  {
    ...
    items: [
      ...
      'Search across what went up and who put it up — writers, walls, captions, talk.',
      'Crews: a shared tag, a crew page, a roster, and a handoff to the people in it.',
      'Post as your crew straight from the top bar, and switch back to you when you are done.',
      'Word — messages nobody else can read. Not us either. Start one with any writer or crew right from the Word screen.',
      'Shout-outs: somebody says your name in the talk, you see it.',
      'Stickers for tags and crews. A picture, never a face required.',
      'Getting put on — an established writer vouches for the next one, and the newcomer’s wait goes away.',
      'Happenings — jams and meets with the date on the post, gone a week after.',
      'Optional face blur before a flick leaves your phone. On the device, permanent, nothing goes anywhere to be looked at.',
      'Recovery you can opt into: lock a spare blackbook with a passphrase and leave it here. We hold a locked file we cannot open.',
      'The mirror on the onion network — the whole place, straight to the box, nothing in the middle that can see who came by.',
      'Nightly copies of the whole wall, so a dead box never takes it with it.',
      'The app tells you when a fresh coat is ready instead of quietly running stale.',
  ...
  },
  {
    ...
    items: [
      'Cities under one name, so sf and san-francisco stop being different walls.',
      'Add to a flick after it is up — tag the writers in it, put it on the wall it belongs on.',
    ],
  },
  {
    kicker: 'next up',
    ...
    items: [
      'Hand blur to go with the face blur. Same rule: on the device, permanent.',
